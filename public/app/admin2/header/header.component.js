    ...
    return {
        ...
        execute: function() {
            HeaderComponent = (function () {
                function HeaderComponent(_loginService, _storageService, _router, _notification, activatedRoute) {
                    this._loginService = _loginService;
                    this._storageService = _storageService;
                    this._router = _router;
                    this._notification = _notification;
                    this.activatedRoute = activatedRoute;
                    this._sideBarColors = ['blue', 'azure', 'green', 'orange', 'red', 'purple'];
                    this.selectedSideBarColor = new core_1.EventEmitter();
                }
                ...
                HeaderComponent.prototype.sendSideBarColor = function (selectedColor) {
                    this.selectedSideBarColor.emit(selectedColor);
                };
                __decorate([
                    core_1.Output("sideBarColor"), 
                    __metadata('design:type', core_1.EventEmitter)
                ], HeaderComponent.prototype, "selectedSideBarColor", void 0);
                HeaderComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [login_service_1.LoginService, storage_service_1.StorageService, router_1.Router, angular2_notifications_1.NotificationsService, router_1.ActivatedRoute])
                ], HeaderComponent);
