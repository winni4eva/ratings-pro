        ...
        execute: function() {
            ReportComponent = (function () {
                ...
                function ReportComponent(_reportService, _notification, _fileService, _branchService, _surveyService) {
                    ...
                    this.overviewpiecharts = [];
                    this.overviewbarcharts = [];
                    this._options = {
                        position: ["top", "right"],
                        timeOut: 9000,
                        lastOnBottom: true
                ...
                ReportComponent.prototype.getReport = function (filter) {
                    ...
                    this._reportService.getReport(filter).subscribe(function (result) {
                        switch (_this.clickedTab) {
                            case 'Overview':
                                _this.overviewpiecharts = result.report.pie;
                                _this.overviewbarcharts = result.report.bar;
                                _this.overViewtable = result.raw;
                                break;
                            case 'Branches':
                                _this.branchespiecharts = result.report.pie;
                                _this.branchesbarcharts = result.report.bar;
