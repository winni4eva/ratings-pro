    ...
    return {
        ...
        execute: function() {
            HomeService = (function () {
                function HomeService(http, _storage) {
                    this.http = http;
                    this._storage = _storage;
                    this._apiUrl = '/api/v1/ratings';
                    this._userApiUrl = '/api/v1/users';
                }
                HomeService.prototype.addRating = function (rating) {
                    return this.http.post(this._apiUrl, JSON.stringify(rating))
                        .map(this.extractData)
                        .catch(this.handleError);
                };
                HomeService.prototype.getUserSurveys = function () {
