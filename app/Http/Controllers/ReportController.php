...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        switch ($request->get('tab')) {
            case 'Overview':
                $report = $this->reportService->getSurveys( $request->all(), $allowedBranches );
            ...
            case 'Surveys':
                ...
                break;
            case 'Ratings':
                $report = $this->reportService->getRatings( $request->all(), $allowedBranches );
            ...
            case 'Branches':
                ...
                $raw = $this->reportService->getBranchSurveyAverages( $request->all(), $allowedBranches );
                break;
            default:
                # code...
                break;
